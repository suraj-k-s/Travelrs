...
<html>
    ...
    <% if (request.getParameter("save") != null) {
            ...
            String seluser = "select * from tbl_guide where guide_password ='" + Cpass + "' and user_id='" + session.getAttribute("guideid") + "' ";
            out.print(seluser);
            ResultSet s1 = con.selectCommand(seluser);
            if (s1.next()) {
                if (Npass.equals(REpass)) {
                    String upd = "update tbl_guide set user_password='" + REpass + "' where guide_id ='" + session.getAttribute("guideid") + "' ";
