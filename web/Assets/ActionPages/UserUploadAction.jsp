...
//checking if request cotains multipart data
    ...
    if (isMultipart) {
        ...
        if (value[7].equals(value[8])) {
            String InsQry = "INSERT INTO tbl_user( user_name,user_address,user_gender,user_contact,user_photo,user_proof,user_email,place_id,user_password)"
                    + "values('" + value[0] + "','" + value[1] + "','" + value[2] + "','" + value[3] + "','" + photo + "','" + proof + "','" + value[4] + "','" + value[6] + "','" + value[7] + "')";
