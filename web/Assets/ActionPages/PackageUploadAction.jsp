        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            } else//when it is an image or multipart
            {
                ...
                if (field_name.equals("filephoto"))//write the name of image here it is img_product
                {
                    ...
                    photo = "PackagePhoto_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
            ...
            String InsQry = "INSERT INTO tbl_package(package_name,package_price,package_details,package_photo,place_id)"
                    + "values('" + value[0] + "','" + value[1] + "','"  + value[2] + "','" + photo + "','" + value[5] + "' )";
...
<<script type="text/javascript">
    alert("Package Added");
    setTimeout(function() {
        window.location.href = '../../Admin/add package.jsp'
