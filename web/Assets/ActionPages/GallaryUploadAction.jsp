<%-- 
    Document   : GallaryUploadAction
    Created on : 21 Mar, 2024, 12:48:57 PM
...
<%
    ...
    if (isMultipart) {
        ...
        String InsQry = "INSERT INTO tbl_gallary(gallary_caption	, gallary_photo, package_id)"
