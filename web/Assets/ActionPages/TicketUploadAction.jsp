        ...
        while (itr.hasNext())//checking if there is any value in the position like rs.next()
        {
            ...
            } else//when it is an image or multipart
            {
                ...
                if (field_name.equals("photo"))//write the name of image here it is img_product
                {
                    ...
                    photo = "ticket_" + r_num + ext;//generating random number for images so this name and format of imagewil be stored inside the server
...
//        if (value[6].equals(value[7])) {
            String InsQry = "update tbl_ticketbookinghead set ticket_file = '"+photo+"' where head_id = '"+value[0]+"'";
...
<script type="text/javascript">
    alert("Tickect uploaded");
    setTimeout(function() {
        window.location.href = '../../Agency/viewticket.jsp'
